...
- Measured (leakage-free, docs/EVALUATION.md): XGBoost 0.60 recall / 0.37 precision / 0.77 AUC; heuristic 0.50 recall / 0.24 precision on 278 Wikidata-verified acquisitions. NOTE: training_data.csv labels come from cross_cik/name_match heuristics that are also features — never quote accuracy measured on it.
